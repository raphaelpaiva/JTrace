...
public class Vector3D {
	...
	/**
	 * Creates a {@link Vector3D} from a {@link Point3D} representing its coordinates.
	 * 
	 * @param coordinate a {@link Point3D} representing the Vector coordinates.
	 */
	 ...
	 * 
	 * @param a {@link Point3D} where the vector starts.
	 * @param b {@link Point3D} where the vector ends.
	 */
	 ...
	 * s*A = B(s*x, s*y, s*z)
	 * 
	 * @param multiplier the scalar value to multiply the {@link Vector3D} by.
	 * @return a new {@link Vector3D} equivalent to <code>(this*multiplier)</code>
	 */
	 ...
	 * A.B = x*u + y*v + z*w
	 * 
	 * @param v2 the {@link Vector3D} to perform the dot product with.
